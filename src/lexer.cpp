...
static const std::map<char32_t, uint32_t> categories_table = {
    ...
    {'д', 1376256}, {'е', 1376256}, {'ж', 1245184}, {'з', 1245184}, 
    ...
    {'ш', 720896},  {'щ', 1245184}, {'ъ', 720896},  {'ы', 1245184}, 
...
static const Elem delim_jump_table[] = {
    ...
    {const_cast<char32_t*>(U""), BorAssign, 0},         
    {const_cast<char32_t*>(U""), LorAssign, 0},         
    ...
    {const_cast<char32_t*>(U""), LNorAssign, 0},        
    {const_cast<char32_t*>(U""), LNXorAssign, 0},       
    {const_cast<char32_t*>(U""), LNAndAssign, 0},       
    ...
    {const_cast<char32_t*>(U""), BXorAssign, 0},        
    {const_cast<char32_t*>(U""), LXorAssign, 0},        
    ...
    {const_cast<char32_t*>(U""), BNorAssign, 0},        
    {const_cast<char32_t*>(U""), BNXorAssign, 0},       
    {const_cast<char32_t*>(U""), BNAndAssign, 0},       
    {const_cast<char32_t*>(U":"), Plus, 60},            
    {const_cast<char32_t*>(U"="), Unknown, 61},         
    {const_cast<char32_t*>(U""), PlusAssign, 0},        
    {const_cast<char32_t*>(U":"), Minus, 63},           
    {const_cast<char32_t*>(U"="), Unknown, 64},         
    {const_cast<char32_t*>(U""), MinusAssign, 0},       
    ...
    {const_cast<char32_t*>(U""), MultAssign, 0},        
    {const_cast<char32_t*>(U"="), Unknown, 79},         
    {const_cast<char32_t*>(U""), PowAssign, 0},         
    {const_cast<char32_t*>(U""), FPowAssign, 0},        
    ...
    {const_cast<char32_t*>(U""), DivAssign, 0},         
    {const_cast<char32_t*>(U""), FDivAssign, 0},        
    {const_cast<char32_t*>(U":"), Module, 88},          
    {const_cast<char32_t*>(U"="), Unknown, 89},         
    {const_cast<char32_t*>(U""), ModuleAssign, 0}
};
